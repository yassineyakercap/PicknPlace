...
class BasicNavigator(Node):
    def __init__(self):
        ...
        self.point_a = self.declare_parameter('point_a', [0.0, 0.0]).value
        self.point_b = self.declare_parameter('point_b', [1.0, 1.0]).value
        ...
        self.nav_to_pose_client = ActionClient(self, NavigateToPose, '/amr1/navigate_to_pose')
...
def main(args=sys.argv):
    ...
    initial_pose.orientation.z = -0.00460209633546322
    ...
    goal_pose.pose.position.y = 6.20
